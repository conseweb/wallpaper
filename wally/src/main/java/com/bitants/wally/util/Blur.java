...
package com.bitants.wally.util;
 ...
 * Modified by Freddie (Musenkishi) Lust-Hed on 2014-04-13.
 */
public class Blur {
    ...
    public static Bitmap apply(Context context, Bitmap bitmap, int radius) {
        ...
        int w = blurBitmap.getWidth();
        int h = blurBitmap.getHeight();
