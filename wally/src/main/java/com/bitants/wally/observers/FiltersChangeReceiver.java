...
package com.bitants.wally.observers;
 ...
 * "com.bitants.wally.observers.FILTERS_CHANGED" is broadcast.
 *
 * Created by Freddie (Musenkishi) Lust-Hed on 2014-09-24.
 */
public class FiltersChangeReceiver extends BroadcastReceiver {

    public static final String FILTERS_CHANGED = "com.bitants.wally.observers.FILTERS_CHANGED";
