...
package com.bitants.wally.dataprovider;
...
import com.bitants.wally.dataprovider.util.Parser;
import com.bitants.wally.models.ExceptionReporter;
import com.bitants.wally.models.Filter;
import com.bitants.wally.models.Image;
import com.bitants.wally.models.ImagePage;
import com.bitants.wally.models.filters.FilterGroupsStructure;
...
public class DataProvider {
    ...
    public void getImages(String path, String query, String color, int index, FilterGroupsStructure filterGroupsStructure, final OnImagesReceivedListener onImagesReceivedListener) {
        new NetworkDataProvider().getData(path, query, color, index, filterGroupsStructure, new NetworkDataProvider.OnDataReceivedListener() {
            @Override
    ...
    public void getImages(String path, int index, FilterGroupsStructure filterGroupsStructure, final OnImagesReceivedListener onImagesReceivedListener) {
        ...
        new NetworkDataProvider().getData(path, index, filterGroupsStructure, new NetworkDataProvider.OnDataReceivedListener() {
            @Override
            public void onData(String data, String url) {
                ArrayList<Image> images = parser.parseImages(data);
                if (onImagesReceivedListener != null) {
    ...
    public void getPageData(String imagePageUrl, final OnPageReceivedListener onPageReceivedListener) {
        new NetworkDataProvider().getData(imagePageUrl, new NetworkDataProvider.OnDataReceivedListener() {
            @Override
            public void onData(String data, String url) {
